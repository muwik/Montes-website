            ...
            <div class="mc-error-section__wrapper d-flex flex-column flex-md-row-reverse justify-content-end position-relative">
                ...
                <div class="mc-error-section__images">
                    <div class="img-wrapper mc-bg-color-blue">
                        <picture>
                            <source type="image/webp" srcset="images/img-piano.webp" width="50" height="45">
                            <img src="images/img-piano.png" alt="" width="50" height="45" >
                        </picture>
                    </div>
                    <div class="img-wrapper mc-bg-color-aqua">
                        <picture>
                            <source type="image/webp" srcset="images/img-dance.webp" width="50" height="75">
                            <img src="images/img-dance.png" alt="" width="50" height="75" >
                        </picture>
                    </div>
                    <div class="img-wrapper mc-bg-color-pink">
                        <picture>
                            <source type="image/webp" srcset="images/img-art.webp" width="50" height="75">
                            <img src="images/img-art.png" alt="" width="50" height="75" >
                        </picture>
                    </div>
                </div>
